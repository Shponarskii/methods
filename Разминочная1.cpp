...
int main()
{
    ...
    while (flag == 1)
    {
        ...
        if (Max2 < accur)
        {
            ...
            int size1 = size - r;
            q2 /= size1;
            cout << "—таршее по модулю собственное число:" << endl;
            cout << fixed << setprecision(15) << q2 << endl;
            cout << "—обственный вектор, соответствующий этому собственному числу:";
            cout << endl;
            for (int i = 0; i < size; i++)
        ...
        {
            flag = 0;
            cout << "ћетод не сходитс€ к наибольшему по модулю собственному числу" << endl;
        }
    }
}